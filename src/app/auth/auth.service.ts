...
export class AuthService {
  ...
  uploadBanner(pageName : string,imageFile : string, title : string,subtitle : string) : Observable <any> {
    return Observable.create(observer => {
      this.http.post('/api/banner/uploadbanner', {
        pageName,
        imageFile,
        title,
        subtitle 
  ...
  setUser(user): void {
    ...
    this.token.saveUser(JSON.stringify(user)); 
  }
